...
begin
    ...
    dm.query_pessoas.SQL.Add('update pessoas set matriz = :nome where matriz = :nomeAntigo');
    ...
    dm.query_usuarios.SQL.Add('update usuarios set matriz = :nome where matriz = :nomeAntigo');
...
begin
  ...
  MessageDlg('Salvo com Sucesso!!', mtInformation, mbOKCancel, 0);
    ...
    dm.query_filial.SQL.Add('insert into filial (nome, endereco, numero, bairro, cidade, telefone, matriz) values (:nome, :endereco, :numero, :bairro, :cidade, :telefone, :matriz)');
    dm.query_filial.ParamByName('nome').Value := edtNome.Text;
    dm.query_filial.ParamByName('endereco').Value := edtEndereco.Text;
    ...
    dm.query_filial.ParamByName('telefone').Value := edtTel.Text;
    dm.query_filial.ParamByName('matriz').Value := edtNome.Text;
